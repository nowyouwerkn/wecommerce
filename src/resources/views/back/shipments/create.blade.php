        ...
        <div class="row">
            ...
            <div class="col-md-8">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="local">Ofrece entrega local</label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mg-t-10 mb-4">
                    <!-- Header -->
                    <div class="card-header pd-t-20 pd-b-0 bd-b-0">
                        <h5 class="mg-b-5">Entrega en tienda</h5>
                        <p class="tx-12 tx-color-03 mg-b-0">Entrega en tienda.</p>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="store">Ofrece entrega en tienda</label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mg-t-10 mb-4">
                    <!-- Header -->
                    <div class="card-header pd-t-20 pd-b-0 bd-b-0">
                        <h5 class="mg-b-5">Paquetes</h5>
                        <p class="tx-12 tx-color-03 mg-b-0">Paquetes.</p>
                    </div>
                ...
                <div class="card mg-t-10 mb-4">
                    <!-- Header -->
                    <div class="card-header pd-t-20 pd-b-0 bd-b-0">
                        <h5 class="mg-b-5">Tarifas</h5>
                        <p class="tx-12 tx-color-03 mg-b-0">Tarifas.</p>
                    </div>
