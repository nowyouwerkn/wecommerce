...
@section('content')
                ...
                <div class="card-body text-secondary">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-9">
                            ...
                            <a class="card-text" href="javascript:void(0)" data-toggle="modal"
                                data-target="#guideModal">Open Guide</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0" style="height: 600px; overflow: hidden;">
                        <img style="transform: rotate(90deg);width: 130%;height: auto;top: 26%;position: relative;left: -13%;"
                            src="{{ asset('img/tracking-labels/' . $order->package->package_label_file) }}">
                    </div>
                    <div class="modal-footer">
                        <a href="#"
                            onclick="printJS( '{{ asset('img/tracking-labels/' . $order->package->package_label_file) }}', 'image');return false;">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="d-flex align-items-center status-row">
                ...
                <div class="status-box bg-dark text-white" data-toggle="tooltip" data-placement="bottom"
                    title="ID de Pago: {{ $order->payment_id }}">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <p class="mb-0"><strong>Cuenta:</strong> <a
                            href="{{ route('clients.show', $order->user_id) }}">{{ $order->user->name }}</a></p>
                    ...
                    <p><span class="text-muted"><i class="far fa-clock"></i>
                            {{ Carbon\Carbon::parse($order->created_at)->translatedFormat('d M Y - h:ia') }}</span></p>
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                @if ($order->cart == null)
                    <p class="alert alert-warning">Esta orden proviene de una importación de otro sistema. Es posible que
                        la información mostrada esté incompleta.</p>
                @endif
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                        ...
                        <div class="col text-right">
                            <p class="mb-0" style="font-size: 1.3em;">
                                <strong>${{ number_format($order->cart_total, 2) }}</strong>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <p class="mb-0" style="font-size: 1.3em;">
                                <strong>${{ number_format($order->shipping_rate, 2) ?? 'N/A' }}</strong>
                            </p>
                        </div>
                        @if (!empty($shipping_option))
                            <div class="col-12">
                                <p class="mb-0 text-info">Seleccionado: {{ $shipping_option->name }}</p>
                            </div>
                        @endif
                    </div>
                    <hr>
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <p class="mb-0" style="font-size: 1.3em;">
                                <strong>${{ number_format($order->sub_total, 2) ?? 'N/A' }}</strong>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <p class="mb-0" style="font-size: 1.3em;">
                                <strong>${{ number_format($order->discounts, 2) ?? 'N/A' }}</strong>
                            </p>
                        </div>
                    </div>
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            ...
                            @else
                                <p class="mb-0" style="font-size: 1.3em;">
                                    <strong>{{ $order->coupon_id ?? 'n/a' }}</strong>
                                </p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <p class="mb-0" style="font-size: 1.3em;">
                                <strong>${{ number_format($order->tax_rate, 2) ?? 'N/A' }}</strong>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <p class="mb-0" style="font-size: 1.3em;">
                                <strong>${{ number_format($order->payment_total, 2) ?? 'N/A' }}</strong>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-8">
            @if ($order->type == 'single_payment')
                <div class="card mb-4">'
                    ...
                    <div class="card-body">
                        @if ($order->cart == null)
                            <p class="alert alert-warning">Esta orden proviene de una importación de otro sistema. El
                                "módulo carrito" no es compatible con la información y no puede mostrar los detalles.</p>
                        @else
                            @foreach ($order->cart->items as $item)
                                <div class="card d-flex flex-row mb-3">
                                    <a class="d-flex" href="#">
                                        <img height="40px" alt="{{ $item['item']['name'] }}"
                                            src="{{ asset('img/products/' . $item['item']['image']) }}"
                                            class="list-thumbnail responsive border-0 card-img-left">
                                    </a>
                                    <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                                        <div
                                            class="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                                            <a href="{{ route('products.show', $item['item']['id']) }}"
                                                class="w-40 w-sm-100">
                                                <p class="list-item-heading mb-1 truncate">{{ $item['item']['name'] }}</p>
                                            </a>
                                            <p class="mb-1 text-muted text-small w-15 w-sm-100">Talla:
                                                {{ $item['variant'] }}</p>
                                            <p class="mb-1 text-muted text-small w-15 w-sm-100">{{ $item['qty'] }} Par
                                            </p>
                                        </div>
                    ...
                    <div class="card-footer bg-transparent pd-y-10 pd-sm-y-15 pd-x-10 pd-sm-x-20 dont-print">
                        <nav class="nav nav-with-icon tx-13">
                            <a href="javascript:void(0)" class="nav-link" data-toggle="modal"
                                data-target="#resendMail"><i class="fas fa-envelope mr-2"></i> Reenviar confirmación de
                                orden</a>
                            @if (!empty($shipping_option) && $shipping_option->type == 'pickup')
                            @else
                                <a href="{{ route('order.packing.list', $order->id) }}" class="nav-link"><i
                                        class="fas fa-print mr-2"></i> Imprimir la lista de empaque</a>
                            @endif
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div
                                        ...
                                        <h6 class="tx-13 tx-spacing-1 tx-uppercase tx-semibold mg-b-0">Recolección en
                                            Tienda</h6>
                                        ...
                                        @if ($order->status == 'Entregado')
                                            <p class="mb-0 text-success text-uppercase"><i class="fas fa-check"></i>
                                                Pedido Completo</p>
                                        @endif
                                    ...
                                    <div class="card-body pd-25">
                                        <div class="d-flex justify-content-between">
                                            <img src="{{ asset('assets/img/pickup_1.svg') }}" alt="Listo para Recolercar"
                                                class="mb-4" width="180">
                                            <img src="{{ asset('assets/img/delivery_1.svg') }}"
                                                alt="Entregado al Cliente" class="mb-4" width="180">
                                        </div>
                                        ...
                                        <div class="d-flex align-items-start justify-content-between">
                                            @if ($order->status == 'Empaquetado' or $order->status == 'Entregado')
                                                <a href=""
                                                    class="btn btn-sm pd-x-15 btn-white btn-uppercase disabled"><i
                                                        class="fas fa-box mr-2"></i> Marcar como Empaquetado</a>
                                            @else
                                                <div>
                                                    <a href="{{ route('order.status.static', [$order->id, 'Empaquetado']) }}"
                                                        class="btn btn-sm pd-x-15 btn-white btn-uppercase"><i
                                                            class="fas fa-box mr-2"></i> Marcar como Empaquetado</a>
                                                    <small class="text-mute mt-2 d-block">Se enviará un correo de
                                                        notificación al comprador.</small>
                                                </div>
                                            @endif
                                            ...
                                            @if ($order->status == 'Entregado')
                                                <a href=""
                                                    class="btn btn-sm pd-x-15 btn-white btn-uppercase disabled"><i
                                                        class="fas fa-box-open mr-2"></i> Marcar como Entregado</a>
                                            @else
                                                <a href="{{ route('order.status.static', [$order->id, 'Entregado']) }}"
                                                    class="btn btn-sm pd-x-15 btn-white btn-uppercase"><i
                                                        class="fas fa-box-open mr-2"></i> Marcar como Entregado</a>
                                            @endif
                                        </div>
            ...
            @else
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="card d-flex flex-row mb-3">
                            <a class="d-flex" href="#">
                                <img height="40px" alt="{{ $order->subscription->name }}"
                                    src="{{ asset('img/products/' . $order->subscription->image) }}"
                                    class="list-thumbnail responsive border-0 card-img-left">
                            </a>
                            <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                                <div
                                    class="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                                    <a href="{{ route('products.show', $order->subscription->id) }}"
                                        class="w-40 w-sm-100">
                    ...
                    @if ($order->subscription_status == true)
                        <div class="card-footer bg-transparent pd-y-10 pd-sm-y-15 pd-x-10 pd-sm-x-20 dont-print">
                            <nav class="nav nav-with-icon tx-13">
                                <a href="{{ route('order.cancel.subscription', $order->id) }}"
                                    class="nav-link text-danger"><i class="fas fa-ban mr-2"></i> Cancelar Suscripción</a>
                            </nav>
                        </div>
                    @endif
                </div>
            ...
            <div class="card mb-4">
                <div class="card-header pd-y-15 pd-x-20 d-flex align-items-center justify-content-between">
                    ...
                    <nav class="nav nav-with-icon tx-13">
                        <a href="" class="nav-link" data-toggle="modal" data-target="#noteModal"><svg
                                ...
                                <div class="col-2">
                                    <div class="user-image text-center mr-3">
                                        @if ($note->user->image == null)
                                            <img class="thumb-md rounded-circle mr-4" width="50"
                                                src="{{ 'https://www.gravatar.com/avatar/' . md5(strtolower(trim($note->user->email))) . '?d=retro&s=200' }}"
                                                alt="{{ $note->user->name }}">
                                        @else
                                            <img class="thumb-md rounded-circle mr-4" width="50"
                                                src="{{ asset('img/usuarios/' . $note->user->image) }}"
                                                alt="{{ $note->user->name }}">
                                        @endif
            ...
            <div class="card mg-t-10 mb-4">
                <div class="card-header pd-y-15 pd-x-20 d-flex align-items-center justify-content-between">
                    ...
                    @php
                        $logs = Nowyouwerkn\WeCommerce\Models\Notification::where('type', 'Orden')
    ...
    <div class="row">
        <div class="col-md-4 mt-3">
            <button id="print" class="btn btn-default btn-primary btn-block btn-lg mt-4" type="button"> <span><i
                        class="fa fa-print"></i> Imprimir Orden</span></button>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="service_name" placeholder=""
                                        required="">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tracking_number" placeholder=""
                                        required="">
                                </div>
                            </div>
    ...
    <div class="modal fade" id="resendMail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form method="POST" action="{{ route('resend.order.mail', $order->id) }}"
