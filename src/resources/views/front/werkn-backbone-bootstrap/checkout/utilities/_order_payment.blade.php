                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <div class="mb-0 mt-3">
                            ...
                            <label><input class="billing_check" type="checkbox" name="billing_shipping" value="true">  La dirección de facturación es igual que dirección de envio</label>
                        </div>
                    </div>

                    <div class="col-md-12">
                        <div id="billingForm" class="row mt-3">
                            <div class="col-md-12 ">
                                <hr>
