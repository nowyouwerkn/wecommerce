...
@section('content')
    ...
    <section class="mt-5 mb-5 container we-co--checkout-container">
        <form action="{{ route('checkout.subscription.store', $subscription->id) }}" method="POST" id="checkout-form"
            data-parsley-validate="" data-parsley-excluded="[disabled=disabled]">
