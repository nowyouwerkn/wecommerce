<div class="card card-body card-order mb-5">
    ...
    @else
        <div class="card order-card-product py-0 px-3 mb-3 ps-1">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <img height="45px" alt="{{ $order->subscription->name }}" src="{{ asset('img/products/' . $order->subscription->name ) }}">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 me-2">
                            ...
                            <p class="mb-0">Siguiente pago: {{ Carbon\Carbon::parse($order->subscription_period_start)->addMonths(1) }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="pl-1 align-self-center pr-4">
                        <p class="mb-0"><strong>${{ $order->subscription->price }}</strong></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="order-card-info">
            <table class="table">
                ...
                <tbody>
                  <tr>
                    <th scope="row"><strong>${{ number_format($order->payment_total, 2) ?? 'N/A' }}</strong></th>
