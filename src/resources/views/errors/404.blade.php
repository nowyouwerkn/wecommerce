...
<div class="container error-text">
    <div class="row align-items-center">
    	<div class="col-md-4">
    		<div>
    			<img class="img-fluid" src="{{ asset('img/errors/404.svg') }}">
    		</div>
    	</div>
		<div class="col-md-8">
    		<div class="p-5">
    			...
    			<p class="error-p">No se encuentra el contenido que buscas. Te dejamos unos links que podrían ser útiles.</p>
