...
<div class="container error-text">
    <div class="row align-items-center">
    	<div class="col-md-4">
    		<div>
    			<img class="img-fluid" src="{{ asset('img/errors/429.svg') }}">
    		</div>
    	</div>
		<div class="col-md-8">
    		<div class="p-5">
    			...
    			<p class="error-p">Demasiadas peticiones en poco tiempo. Espera un poco y vuelve a intentarlo. Te dejamos unos links que podrían ser útiles.</p>
