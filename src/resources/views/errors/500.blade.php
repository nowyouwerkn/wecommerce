...
<div class="container error-text">
    <div class="row align-items-center">
    	<div class="col-md-4">
    		<div>
    			<img class="img-fluid" src="{{ asset('img/errors/500.svg') }}">
    		</div>
    	</div>
		<div class="col-md-8">
    		<div class="p-5">
    			...
    			<p class="error-p">Error del servidor, esto puede pasar por múltiples razones, pero no te preocupes, utiliza alguno de los siguientes links que podrían ser útiles.</p>
