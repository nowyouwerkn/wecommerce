	...
	<center>
		...
		<table style="width: 100%;"  cellspacing="20">
			<tbody>
				<tr>
					<td>
						<h1 style="margin-bottom:0px; text-transform: uppercase;">Tu factura está lista.</h1>
						<p style="margin-top: 10px; line-height: 1.8;">Gracias por comprar con nosotros, hemos adjuntado la factura de tu órden en este correo.</p>
