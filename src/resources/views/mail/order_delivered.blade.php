	...
	<center>
		...
		<table style="width: 100%;"  cellspacing="20">
			<tbody>
				<tr>
					<td>
						<h1 style="margin-bottom:0px; text-transform: uppercase;">Se ha completado la entrega de tu pedido.</h1>
						<p style="margin-top: 10px; line-height: 1.8;">¡Entregamos exitosamente tu pedido!</p>
