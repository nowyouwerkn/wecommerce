...
$('[data-countdown]').each(function () {
	...
	$this.countdown(finalDate, function (event) {
		$this.html(event.strftime('<div class="time-count day"><span>%D</span>Días</div><div class="time-count hour"><span>%H</span>Horas</div><div class="time-count min"><span>%M</span>Min</div><div class="time-count sec"><span>%S</span>Seg</div>'));
	});
});
