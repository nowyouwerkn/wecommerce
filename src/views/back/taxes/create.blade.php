    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-header card-body">
                ...
                <a href="" class="btn btn-outline-secondary btn-block btn-sm" data-toggle="modal" data-target="#modalCreate">Crear nueva región</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-vertical-center" role="document">
        <div class="modal-content bd-0 tx-14">
            ...
            <form method="POST" action="{{ route('taxes.store') }}" enctype="multipart/form-data">
                ...
                <input type="text" name="parent_tax_id" value="{{ $country->id }}">
